...
(function(root, factory) {
  ...
  beforeEach(() => {
    instance = new ShopApi.BasketModel()
  });
  ...
  describe('BasketModel', function() {
    it('should create an instance of BasketModel', function() {
      // uncomment below and update the code to test BasketModel
      //var instane = new ShopApi.BasketModel()
      //expect(instance).to.be.a(ShopApi.BasketModel);
    });
