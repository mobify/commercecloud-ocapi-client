...
(function(root, factory) {
  ...
  beforeEach(() => {
    instance = new ShopApi.CustomerOrderResultModel()
  });
  ...
  describe('CustomerOrderResultModel', function() {
    it('should create an instance of CustomerOrderResultModel', function() {
      // uncomment below and update the code to test CustomerOrderResultModel
      //var instane = new ShopApi.CustomerOrderResultModel()
      //expect(instance).to.be.a(ShopApi.CustomerOrderResultModel);
    });
