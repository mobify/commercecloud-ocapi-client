...
(function(root, factory) {
  ...
  beforeEach(() => {
    instance = new ShopApi.OrderAddressModel()
  });
  ...
  describe('OrderAddressModel', function() {
    it('should create an instance of OrderAddressModel', function() {
      // uncomment below and update the code to test OrderAddressModel
      //var instane = new ShopApi.OrderAddressModel()
      //expect(instance).to.be.a(ShopApi.OrderAddressModel);
    });
