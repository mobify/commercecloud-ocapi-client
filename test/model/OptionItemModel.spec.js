...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShopApi.OptionItemModel()
  });
  ...
  describe('OptionItemModel', function() {
    it('should create an instance of OptionItemModel', function() {
      // uncomment below and update the code to test OptionItemModel
      //var instane = new ShopApi.OptionItemModel()
      //expect(instance).to.be.a(ShopApi.OptionItemModel);
    });
