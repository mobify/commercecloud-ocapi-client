...
(function(root, factory) {
  ...
  beforeEach(() => {
    instance = new ShopApi.OrderSearchResultModel()
  });
  ...
  describe('OrderSearchResultModel', function() {
    it('should create an instance of OrderSearchResultModel', function() {
      // uncomment below and update the code to test OrderSearchResultModel
      //var instane = new ShopApi.OrderSearchResultModel()
      //expect(instance).to.be.a(ShopApi.OrderSearchResultModel);
    });
