...
(function(root, factory) {
  ...
  beforeEach(() => {
    instance = new ShopApi.VariantModel()
  });
  ...
  describe('VariantModel', function() {
    it('should create an instance of VariantModel', function() {
      // uncomment below and update the code to test VariantModel
      //var instane = new ShopApi.VariantModel()
      //expect(instance).to.be.a(ShopApi.VariantModel);
    });
