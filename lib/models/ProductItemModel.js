...
var _OptionItemModel = require('./OptionItemModel');
...
/**
 * The ProductItemModel model module.
 * @module models/ProductItemModel
 * @version 17.8
 */
var ProductItemModel = function () {
  /**
   * Constructs a new <code>ProductItemModel</code>.
   * Document representing a product item.
   * @alias module:models/ProductItemModel
   * @class
   * @param quantity {Number} The quantity of the products represented by this item.
   */
  function ProductItemModel(quantity) {
    _classCallCheck(this, ProductItemModel);
  ...
  /**
   * Constructs a <code>ProductItemModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:models/ProductItemModel} obj Optional instance to populate.
   * @return {module:models/ProductItemModel} The populated <code>ProductItemModel</code> instance.
   */


  _createClass(ProductItemModel, null, [{
    key: 'constructFromObject',
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ProductItemModel();
        ...
        if (data.hasOwnProperty('bundled_product_items')) {
          obj['bundled_product_items'] = _ApiClient2.default.convertToType(data['bundled_product_items'], [ProductItemModel]);
        }
        ...
        if (data.hasOwnProperty('option_items')) {
          obj['option_items'] = _ApiClient2.default.convertToType(data['option_items'], [_OptionItemModel2.default]);
        }
...
exports.default = ProductItemModel;