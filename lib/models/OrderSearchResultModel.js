...
const _OrderSearchHitModel = require('./OrderSearchHitModel')
...
const _ResultPageModel = require('./ResultPageModel')

const _ResultPageModel2 = _interopRequireDefault(_ResultPageModel)

const _SortModel = require('./SortModel')
...
* @version 17.8
*/
const OrderSearchResultModel = (function() {
    /**
