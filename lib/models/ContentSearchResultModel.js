...
const _ContentModel = require('./ContentModel')

const _ContentModel2 = _interopRequireDefault(_ContentModel)

const _ContentSearchRefinementModel = require('./ContentSearchRefinementModel')
...
* @version 17.8
*/
const ContentSearchResultModel = (function() {
    /**
