...
const _ProductListRegistrantModel = require('./ProductListRegistrantModel')
...
const _PublicProductListItemModel = require('./PublicProductListItemModel')
...
* @version 17.8
*/
const PublicProductListModel = (function() {
    /**
