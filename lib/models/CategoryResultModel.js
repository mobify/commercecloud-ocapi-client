...
const _CategoryModel = require('./CategoryModel')
...
* @version 17.8
*/
const CategoryResultModel = (function() {
    /**
    ...
    */
    ...
    _createClass(CategoryResultModel, null, [{
        ...
        value: function constructFromObject(data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('data')) {
                    obj.data = _ApiClient2.default.convertToType(data.data, [_CategoryModel2.default])
                }
...
exports.default = CategoryResultModel
