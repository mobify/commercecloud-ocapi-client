...
const _superagent2 = _interopRequireDefault(_superagent)
...
const ApiClient = (function() {
    function ApiClient(basePath) {
        const defaultHeaders = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {}
        const timeout = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 60000
        const cache = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true
        const enableCookies = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false
    ...
    _createClass(ApiClient, [{
        ...
        */
        ...
        value: function applyAuthToRequest(request, authNames) {
            ...
            authNames.forEach((authName) => {
                const auth = _this2.authentications[authName]
                switch (auth.type) {
                    case 'basic':
        ...
        */
        ...
        value: function callApi(path, httpMethod, pathParams, queryParams, headerParams, formParams, bodyParam, authNames, contentTypes, accepts, returnType) {
            ...
            const request = (0, _superagent2.default)(httpMethod, url)
            ...
            return new Promise((resolve, reject) => {
                request.end((error, response) => {
                    if (error) {
                        ...
                        if (hasErrorMessage) {
                            const fault = _FaultModel2.default.constructFromObject(JSON.parse(error.response.text).fault)
                            reject(fault)
                        }
                        ...
                        try {
                            const data = _this3.deserialize(response, returnType)
