...
var ApiClient = function () {
    function ApiClient(basePath) {
        ...
        var enableCookies = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
            ...
            return new Promise(function (resolve, reject) {
                request.end(function (error, response) {
                    if (error) {
                        ...
                        if (hasErrorMessage) {
                            var fault = _FaultModel2.default.constructFromObject(JSON.parse(error.response.text).fault);
                            reject(fault);
                        }
