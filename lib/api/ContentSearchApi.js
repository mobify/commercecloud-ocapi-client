...
* @version 17.8
*/
const ContentSearchApi = (function() {
   ...
   */
    ...
    _createClass(ContentSearchApi, [{
        ...
        value: function getContentSearchWithHttpInfo(opts) {
            ...
            const returnType = _ContentSearchResultModel2.default
     ...
     */
        ...
        value: function getContentSearch(opts) {
            return this.getContentSearchWithHttpInfo(opts).then((response_and_data) => {
...
exports.default = ContentSearchApi
