   ...
   */
    ...
    _createClass(OrdersApi, [{
      ...
      // verify the required parameter 'noteId' is set
            ...
            const returnType = _OrderModel2.default
     ...
     */
        ...
        value: function deleteOrdersByIDNotesByID(orderNo, noteId) {
            return this.deleteOrdersByIDNotesByIDWithHttpInfo(orderNo, noteId).then((response_and_data) => {
     ...
     */
        ...
        value: function deleteOrdersByIDPaymentInstrumentsByID(orderNo, paymentInstrumentId) {
            return this.deleteOrdersByIDPaymentInstrumentsByIDWithHttpInfo(orderNo, paymentInstrumentId).then((response_and_data) => {
                return response_and_data.data
            })
        }
     ...
     */
        ...
        value: function getOrdersByID(orderNo) {
            return this.getOrdersByIDWithHttpInfo(orderNo).then((response_and_data) => {
                return response_and_data.data
            })
        }
     ...
     */
      ...
      // verify the required parameter 'orderNo' is set
            ...
            const contentTypes = ['application/json', 'text/xml', 'application/xml']
            const accepts = ['application/json', 'text/xml', 'application/xml']
            const returnType = _NotesResultModel2.default
     ...
     */
        ...
        value: function getOrdersByIDNotes(orderNo) {
          return this.getOrdersByIDNotesWithHttpInfo(orderNo).then((response_and_data) => {
              return response_and_data.data
          })
      }
     ...
     */
      ...
      // verify the required parameter 'orderNo' is set
          ...
          const contentTypes = ['application/json', 'text/xml', 'application/xml']
          const accepts = ['application/json', 'text/xml', 'application/xml']
          const returnType = _PaymentMethodResultModel2.default
     ...
     */
      ...
      value: function getOrdersByIDPaymentMethods(orderNo) {
          return this.getOrdersByIDPaymentMethodsWithHttpInfo(orderNo).then((response_and_data) => {
              return response_and_data.data
          })
      }
     ...
     */
      ...
      value: function patchOrdersByID(orderNo, body) {
          return this.patchOrdersByIDWithHttpInfo(orderNo, body).then((response_and_data) => {
              return response_and_data.data
          })
      }
     ...
     */
      ...
      value: function patchOrdersByIDPaymentInstrumentsByID(orderNo, paymentInstrumentId, body) {
          return this.patchOrdersByIDPaymentInstrumentsByIDWithHttpInfo(orderNo, paymentInstrumentId, body).then((response_and_data) => {
              return response_and_data.data
          })
      }
     ...
     */
      ...
      value: function postOrders(body) {
          return this.postOrdersWithHttpInfo(body).then((response_and_data) => {
              return response_and_data.data
          })
      }
     ...
     */
      ...
      value: function postOrdersByIDNotes(orderNo, body) {
          return this.postOrdersByIDNotesWithHttpInfo(orderNo, body).then((response_and_data) => {
              return response_and_data.data
          })
      }
     ...
     */
      ...
      value: function postOrdersByIDPaymentInstruments(orderNo, body) {
          return this.postOrdersByIDPaymentInstrumentsWithHttpInfo(orderNo, body).then((response_and_data) => {
              return response_and_data.data
          })
      }
  }])
