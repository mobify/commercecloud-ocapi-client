   ...
   */
    ...
    _createClass(ProductsApi, [{
      ...
      // verify the required parameter 'id' is set
            ...
            const returnType = _ProductModel2.default
     ...
     */
        ...
        value: function getProductsByID(id, opts) {
            return this.getProductsByIDWithHttpInfo(id, opts).then((response_and_data) => {
     ...
     */
        ...
        value: function getProductsByIDAvailability(id, opts) {
            return this.getProductsByIDAvailabilityWithHttpInfo(id, opts).then((response_and_data) => {
                return response_and_data.data
            })
        }
     ...
     */
        ...
        value: function getProductsByIDBundledProducts(id, opts) {
            return this.getProductsByIDBundledProductsWithHttpInfo(id, opts).then((response_and_data) => {
                return response_and_data.data
            })
        }
     ...
     */
        ...
        value: function getProductsByIDImages(id, opts) {
          return this.getProductsByIDImagesWithHttpInfo(id, opts).then((response_and_data) => {
              return response_and_data.data
          })
      }
     ...
     */
      ...
      value: function getProductsByIDLinks(id, opts) {
          return this.getProductsByIDLinksWithHttpInfo(id, opts).then((response_and_data) => {
              return response_and_data.data
          })
      }
     ...
     */
      ...
      value: function getProductsByIDOptions(id, opts) {
          return this.getProductsByIDOptionsWithHttpInfo(id, opts).then((response_and_data) => {
              return response_and_data.data
          })
      }
     ...
     */
      ...
      value: function getProductsByIDPrices(id, opts) {
          return this.getProductsByIDPricesWithHttpInfo(id, opts).then((response_and_data) => {
              return response_and_data.data
          })
      }
     ...
     */
      ...
      value: function getProductsByIDPromotions(id, opts) {
          return this.getProductsByIDPromotionsWithHttpInfo(id, opts).then((response_and_data) => {
              return response_and_data.data
          })
      }
     ...
     */
      ...
      // verify the required parameter 'id' is set
          ...
          const contentTypes = ['application/json', 'text/xml', 'application/xml']
          const accepts = ['application/json', 'text/xml', 'application/xml']
          const returnType = _ShippingMethodResultModel2.default
     ...
     */
      ...
      value: function getProductsByIDShippingMethods(id) {
          return this.getProductsByIDShippingMethodsWithHttpInfo(id).then((response_and_data) => {
              return response_and_data.data
          })
      }
     ...
     */
      ...
      value: function getProductsByIDVariations(id, opts) {
          return this.getProductsByIDVariationsWithHttpInfo(id, opts).then((response_and_data) => {
              return response_and_data.data
          })
      }
     ...
     */
      ...
      // verify the required parameter 'ids' is set
          ...
          const contentTypes = ['application/json', 'text/xml', 'application/xml']
          const accepts = ['application/json', 'text/xml', 'application/xml']
          const returnType = _ProductResultModel2.default
     ...
     */
      ...
      value: function getProductsByIDs(ids, opts) {
          return this.getProductsByIDsWithHttpInfo(ids, opts).then((response_and_data) => {
              return response_and_data.data
          })
      }
  }])
