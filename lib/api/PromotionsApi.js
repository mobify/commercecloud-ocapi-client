   ...
   */
    ...
    _createClass(PromotionsApi, [{
      ...
      // verify the required parameter 'campaignId' is set
            ...
            const returnType = _PromotionResultModel2.default
     ...
     */
        ...
        value: function getPromotions(campaignId, opts) {
            return this.getPromotionsWithHttpInfo(campaignId, opts).then((response_and_data) => {
     ...
     */
      ...
      // verify the required parameter 'id' is set
            ...
            const contentTypes = ['application/json', 'text/xml', 'application/xml']
            const accepts = ['application/json', 'text/xml', 'application/xml']
            const returnType = _PromotionModel2.default
     ...
     */
        ...
        value: function getPromotionsByID(id, opts) {
            return this.getPromotionsByIDWithHttpInfo(id, opts).then((response_and_data) => {
                return response_and_data.data
            })
        }
     ...
     */
        ...
        value: function getPromotionsByIDs(ids, opts) {
            return this.getPromotionsByIDsWithHttpInfo(ids, opts).then((response_and_data) => {
                return response_and_data.data
            })
        }
    }])
