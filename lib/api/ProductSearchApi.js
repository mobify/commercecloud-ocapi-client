...
* @version 17.8
*/
const ProductSearchApi = (function() {
   ...
   */
    ...
    _createClass(ProductSearchApi, [{
        ...
        value: function getProductSearchWithHttpInfo(opts) {
            ...
            const returnType = _ProductSearchResultModel2.default
     ...
     */
        ...
        value: function getProductSearch(opts) {
            return this.getProductSearchWithHttpInfo(opts).then((response_and_data) => {
     ...
     */
        ...
        value: function getProductSearchAvailability(opts) {
            return this.getProductSearchAvailabilityWithHttpInfo(opts).then((response_and_data) => {
                return response_and_data.data
            })
        }
     ...
     */
        ...
        value: function getProductSearchImages(opts) {
            return this.getProductSearchImagesWithHttpInfo(opts).then((response_and_data) => {
                return response_and_data.data
            })
        }
     ...
     */
        ...
        value: function getProductSearchPrices(opts) {
          return this.getProductSearchPricesWithHttpInfo(opts).then((response_and_data) => {
              return response_and_data.data
          })
      }
     ...
     */
      ...
      value: function getProductSearchVariations(opts) {
          return this.getProductSearchVariationsWithHttpInfo(opts).then((response_and_data) => {
              return response_and_data.data
          })
      }
  }])
...
exports.default = ProductSearchApi
