   ...
   */
    ...
    _createClass(ContentApi, [{
      ...
      // verify the required parameter 'id' is set
            ...
            const returnType = _ContentModel2.default
     ...
     */
        ...
        value: function getContentByID(id, opts) {
            return this.getContentByIDWithHttpInfo(id, opts).then((response_and_data) => {
     ...
     */
      ...
      // verify the required parameter 'ids' is set
            ...
            const contentTypes = ['application/json', 'text/xml', 'application/xml']
            const accepts = ['application/json', 'text/xml', 'application/xml']
            const returnType = _ContentResultModel2.default
     ...
     */
        ...
        value: function getContentByIDs(ids, opts) {
            return this.getContentByIDsWithHttpInfo(ids, opts).then((response_and_data) => {
                return response_and_data.data
            })
        }
    }])
