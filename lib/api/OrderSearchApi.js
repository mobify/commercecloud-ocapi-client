   ...
   */
    ...
    _createClass(OrderSearchApi, [{
      ...
      // verify the required parameter 'body' is set
            ...
            const returnType = _OrderSearchResultModel2.default
     ...
     */
        ...
        value: function postOrderSearch(body) {
            return this.postOrderSearchWithHttpInfo(body).then((response_and_data) => {
...
exports.default = OrderSearchApi
